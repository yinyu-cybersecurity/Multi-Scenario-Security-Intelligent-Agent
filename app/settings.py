...
class Config:
    ...
    # 项目实际Agent: Explore, Plan, Attack, Verify
    ...
    # Agent模型配置 - 已简化
    # =========================================================================
    # 项目使用4个Agent: Explore, Plan, Attack, Verify
    # 统一使用 LLM_MODEL 配置，如需单独配置可取消注释：

    # EXPLORE_MODEL: str = "deepseek-chat"   # 信息收集
    # PLAN_MODEL: str = "deepseek-chat"      # 攻击规划
    # ATTACK_MODEL: str = "deepseek-chat"    # 漏洞利用
    # VERIFY_MODEL: str = "deepseek-chat"    # 结果验证
